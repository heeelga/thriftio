...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        // Eintrag im Ursprungskonto (Belastung) – mit repeat_until_month und repeat_until_year
        ...
        // Eintrag im Zielkonto (Gutschrift) – ebenfalls mit repeat_until_month und repeat_until_year
